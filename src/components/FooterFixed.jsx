...
function FooterFixed() {
  return (
    <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-black border-t border-purple-500/30 text-gray-300 text-sm py-6 mt-auto">
      <div className="container mx-auto flex justify-center items-center space-x-3">
        <img
          src={intuteLogo}
          alt="Intute.ai Logo"
        ...
        <span className="text-base">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-purple-400 font-semibold hover:text-purple-300 transition-colors duration-200 underline underline-offset-2"
          >
            Intute.ai
          </a>
        </span>
